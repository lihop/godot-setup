...
class Linux extends Platform {
  async preDownload() {
    ...
    if (this.bits == 64) {
      ...
      await exec.exec("sudo apt-get update -y");
      await exec.exec(
        "sudo DEBIAN_FRONTEND='noninteractive' apt-get install -y pulseaudio xvfb libasound2:i386 libpulse0:i386 libxcursor-dev:i386 libxinerama-dev:i386 libxrandr-dev:i386 libxi-dev:i386 libgl-dev:i386 libudev-dev:i386"
      );
    }
