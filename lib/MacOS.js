...
class MacOS extends Platform {
  ...
  _getSuffix() {
    ...
    if (!this.mono) {
      if (semver.lte(version, "3.0.6")) return "osx.fat";
      else if (semver.lt(version, "3.2.4-beta1")) return "osx.64";
      else return "osx.universal";
    } else {
      if (semver.lte(version, "3.0.6")) return "mono_osx64";
      else if (semver.lt(version, "3.4.0-beta1")) return "mono_osx.64";
